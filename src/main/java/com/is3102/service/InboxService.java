...
@Stateless
public class InboxService extends DataAccessService<Inbox> implements Serializable{
    ...
    public Inbox create(Inbox t) {
        ...
        String receivername = parameters.get("newInboxForm:newreceivername");
